...
# FAQ
------
Q: I added a new command into the GUI but it doesn't show up on the list.
A: Click the refresh button.  I haven't figured out how to get the interface to refresh automatically.

Q: I used an add command in Core Features on twitch but I didn't get a response.  Did the command work?
...
Q: I double checked that the command doesn't exist in any other command tab but I still can't add the command.
